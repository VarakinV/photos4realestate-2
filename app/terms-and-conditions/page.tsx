...
const pageUrl = `${siteConfig.url}/terms-and-conditions`;
const title = "Terms and Conditions | Photos 4 Real Estate";
const description =
  "Read the Terms and Conditions governing your use of photos4realestate.ca and the services provided by IKorolova Photos and Marketing Inc.";
  ...
  return (
    <>
      <Breadcrumbs
        ...
        jsonLdId="ld-breadcrumb-terms"
      />

      <section aria-labelledby="page-hero-heading" className="legal-policy-hero">
      ...
      <section className="legal-page-section">
        <div className="container">
          <article className="legal-page-card">
            ...
            <p className="legal-page-meta" style={{ marginTop: "-16px" }}>
              Please read these terms and conditions carefully before using Our Service.
            </p>

            <div className="legal-page-content">

              <section aria-labelledby="tc-interpretation-heading">
                <h2 id="tc-interpretation-heading">Interpretation and Definitions</h2>
                ...
                <ul>
                  <li>
                    ...
                    is under common control with a party, where &ldquo;control&rdquo; means
                  ...
                  <li>
                    ...
                    Company&rdquo;, &ldquo;We&rdquo;, &ldquo;Us&rdquo; or &ldquo;Our&rdquo; in
                    this Agreement) refers to IKorolova Photos and Marketing Inc., 20729 Main St.
                    SE, Calgary, AB, Canada, T3M 3K3.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Terms and Conditions</strong> (also referred as &ldquo;Terms&rdquo;)
                  ...
                  <li>
                    <strong>Website</strong> refers to Photos 4 Real Estate, accessible from{" "}
              ...
              <section aria-labelledby="tc-acknowledgment-heading">
                <h2 id="tc-acknowledgment-heading">Acknowledgment</h2>
                <p>
                ...
                <p>
                  ...
                  the law protects You. Please read Our Privacy Policy carefully before using
                  Our Service.
                </p>
              </section>

              <section aria-labelledby="tc-links-heading">
                <h2 id="tc-links-heading">Links to Other Websites</h2>
                <p>
              ...
              <section aria-labelledby="tc-termination-heading">
                <h2 id="tc-termination-heading">Termination</h2>
                <p>
              ...
              <section aria-labelledby="tc-liability-heading">
                <h2 id="tc-liability-heading">Limitation of Liability</h2>
                <p>
              ...
              <section aria-labelledby="tc-as-is-heading">
                <h2 id="tc-as-is-heading">
                ...
                <p>
                  ...
                  trade practice. Without limitation to the foregoing, the Company provides
              ...
              <section aria-labelledby="tc-governing-law-heading">
                <h2 id="tc-governing-law-heading">Governing Law</h2>
                <p>
              ...
              <section aria-labelledby="tc-disputes-heading">
                <h2 id="tc-disputes-heading">Disputes Resolution</h2>
                <p>
              ...
              <section aria-labelledby="tc-eu-users-heading">
                <h2 id="tc-eu-users-heading">For European Union (EU) Users</h2>
                <p>
              ...
              <section aria-labelledby="tc-us-compliance-heading">
                <h2 id="tc-us-compliance-heading">United States Legal Compliance</h2>
                <p>
                  ...
                  designated by the United States government as a &ldquo;terrorist
                  supporting&rdquo; country, and (ii) You are not listed on any United
                  States government list of prohibited or restricted parties.
                </p>
              </section>

              <section aria-labelledby="tc-severability-heading">
                <h2 id="tc-severability-heading">Severability and Waiver</h2>
              ...
              <section aria-labelledby="tc-translation-heading">
                <h2 id="tc-translation-heading">Translation Interpretation</h2>
                <p>
              ...
              <section aria-labelledby="tc-changes-heading">
                <h2 id="tc-changes-heading">Changes to These Terms and Conditions</h2>
                <p>
              ...
              <section aria-labelledby="tc-contact-heading">
                <h2 id="tc-contact-heading">Contact Us</h2>
                <p>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <Link href="/contact-us">https://photos4realestate.ca/contact-us/</Link>
                  </li>
                  <li>
                    By phone number:{" "}
                    <a
