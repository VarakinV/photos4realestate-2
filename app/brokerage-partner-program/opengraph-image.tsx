...
export const alt =
  "Real Estate Brokerage Partner Program Calgary | Photos 4 Real Estate";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            Recruit and keep better agents with a free marketing kit for every
            agent.
          </h1>
        </div>
        ...
        >
          <span>Brokerage Partner Program</span>
          <span style={{ color: "#cb4154" }}>•</span>
          <span>$0 cost to your brokerage</span>
        </div>
      </div>
    ),
    size
