...
const title = "Privacy Policy | Photos 4 Real Estate";
const description =
  "Read the Privacy Policy of IKorolova Photos and Marketing Inc. to learn how we collect, use, and protect your personal data on photos4realestate.ca.";
  ...
  return (
    <>
      <Breadcrumbs
        ...
        jsonLdId="ld-breadcrumb-privacy-policy"
      />
        ...
        <div className="container">
          <article className="legal-page-card">
            ...
            <div className="legal-page-content">
              <section aria-labelledby="pp-intro-heading">
                <p>
              ...
              <section aria-labelledby="pp-interpretation-heading">
                <h2 id="pp-interpretation-heading">Interpretation and Definitions</h2>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    &ldquo;Our&rdquo; in this Agreement) refers to IKorolova Photos
                    and Marketing Inc., 20729 Main St. SE, Calgary, AB, Canada, T3M
                    3K3.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Website</strong> refers to Photos 4 Real Estate, accessible
                    from <a href={siteConfig.url}>{siteConfig.url}/</a>
                  </li>
                  <li>
              ...
              <section aria-labelledby="pp-collecting-heading">
                <h2 id="pp-collecting-heading">Collecting and Using Your Personal Data</h2>
                ...
                <p>
                  ...
                  <Link href="/cookies-policy">Cookies Policy</Link> or the Cookies
                  section of our Privacy Policy.
                </p>
              </section>

              <section aria-labelledby="pp-use-heading">
                <h2 id="pp-use-heading">Use of Your Personal Data</h2>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    information</strong> about other goods, services and events which we
              ...
              <section aria-labelledby="pp-retention-heading">
                <h2 id="pp-retention-heading">Retention of Your Personal Data</h2>
                <p>
              ...
              <section aria-labelledby="pp-transfer-heading">
                <h2 id="pp-transfer-heading">Transfer of Your Personal Data</h2>
                <p>
              ...
              <section aria-labelledby="pp-delete-heading">
                <h2 id="pp-delete-heading">Delete Your Personal Data</h2>
                <p>
              ...
              <section aria-labelledby="pp-disclosure-heading">
                <h2 id="pp-disclosure-heading">Disclosure of Your Personal Data</h2>
              ...
              <section aria-labelledby="pp-security-heading">
                <h2 id="pp-security-heading">Security of Your Personal Data</h2>
                <p>
              ...
              <section aria-labelledby="pp-children-heading">
                <h2 id="pp-children-heading">Children&apos;s Privacy</h2>
                <p>
              ...
              <section aria-labelledby="pp-links-heading">
                <h2 id="pp-links-heading">Links to Other Websites</h2>
                <p>
              ...
              <section aria-labelledby="pp-changes-heading">
                <h2 id="pp-changes-heading">Changes to this Privacy Policy</h2>
                <p>
              ...
              <section aria-labelledby="pp-contact-heading">
                <h2 id="pp-contact-heading">Contact Us</h2>
                <p>
