...
export const alt = "Real Estate Media Services Calgary | Photos 4 Real Estate";
    ...
    (
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          ...
          />
          <span
            style={{ color: "#fff", fontSize: 34, fontWeight: 600, letterSpacing: "-0.01em" }}
          >
            {siteConfig.name}
          </span>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            Calgary Real Estate Media Services
          </span>
          <h1
            style={{
              color: "#fff",
        ...
        >
          <span>Photography, Video, Drone</span>
          <span style={{ color: "#cb4154" }}>•</span>
          <span>3D Tours &amp; Floor Plans</span>
          <span style={{ color: "#cb4154" }}>•</span>
