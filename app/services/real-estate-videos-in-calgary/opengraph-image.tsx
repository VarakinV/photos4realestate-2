...
export const alt = "Real Estate Videography Calgary | Photos 4 Real Estate";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            Calgary Real Estate Videography
          </span>
          <h1
            style={{
              color: "#fff",
          ...
          >
            Cinematic Property Video Walkthroughs in Calgary
          </h1>
        </div>
