...
export const alt = "Virtual Staging for Calgary Real Estate | Photos 4 Real Estate";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            Photorealistic Virtual Staging for Calgary Listings
          </h1>
        </div>
