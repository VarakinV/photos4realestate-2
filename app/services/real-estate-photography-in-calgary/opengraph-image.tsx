...
export const alt = "Real Estate Photography Calgary | Photos 4 Real Estate";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            MLS-Ready Real Estate Photography in Calgary
          </h1>
        </div>
        ...
        >
          ...
          <span>Blue-Sky Replacement</span>
          <span style={{ color: "#cb4154" }}>•</span>
          <span>From $140 + GST</span>
        </div>
      </div>
    ),
    size
