...
export const alt =
  "Photoshoot checklist for Calgary real estate listings — Photos 4 Real Estate";
    ...
    (
      <div
        style={{
          ...
          background:
            "linear-gradient(135deg, #0e1630 0%, #131d3b 56%, #4f2530 100%)",
          padding: "72px",
          position: "relative",
          overflow: "hidden",
        }}
      >
        ...
        <div style={{ display: "flex", gap: 28, fontSize: 24, color: "rgba(255,255,255,0.82)" }}>
          <span>Interior Prep</span>
          <span style={{ color: "#cb4154" }}>•</span>
          <span>Exterior Prep</span>
          <span style={{ color: "#cb4154" }}>•</span>
