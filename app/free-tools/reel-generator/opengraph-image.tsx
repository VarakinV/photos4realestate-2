...
export const alt =
  "Free social media reel generator Calgary — Photos 4 Real Estate";
    ...
    (
      <div
        style={{
          ...
          background:
            "linear-gradient(135deg, #0e1630 0%, #131d3b 55%, #2a1f5f 100%)",
          padding: "72px",
          position: "relative",
          overflow: "hidden",
        }}
      >
        <div
          style={{
            ...
            background: "linear-gradient(180deg, #7c3aed 0%, #cb4154 100%)",
            opacity: 0.72,
          }}
        />
