...
const qrFaqs: FaqItem[] = [
  ...
  },
  {
    ...
    a: `Additional marketing materials — including social media reels, 20 social media posts, slideshows, flyers, and property websites — are included with Photos 4 Real Estate photography packages once property information is provided. <a href="${marketingKitUrl}">Learn more about the marketing kit &rarr;</a>`,
  },
];
