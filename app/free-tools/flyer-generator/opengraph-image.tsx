...
export const alt =
  "Free property flyer generator Calgary — Photos 4 Real Estate";
    ...
    (
      <div
        style={{
          ...
          background:
            "linear-gradient(135deg, #0e1630 0%, #131d3b 55%, #704414 100%)",
          padding: "72px",
          position: "relative",
          overflow: "hidden",
        }}
