...
const slideshowFaqs: FaqItem[] = [
  ...
  },
  {
    ...
    a: `The free tool creates one self-serve slideshow video. Every Photos 4 Real Estate photography package includes 2 slideshows, 9 social media reels, 3 property websites, and 3 flyers once property information is provided. <a href="${marketingKitUrl}">Learn more about the marketing kit &rarr;</a>`,
  },
  {
