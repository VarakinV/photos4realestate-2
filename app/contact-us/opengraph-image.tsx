...
export const alt = "Contact Photos 4 Real Estate — Calgary";
...
export default async function OgImage() {
  ...
  return new ImageResponse(
    (
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", background: "linear-gradient(135deg, #0e1630 0%, #131d3b 55%, #1e2d5a 100%)", padding: "72px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <span style={{ color: "#f5d0d4", fontSize: 22, textTransform: "uppercase", letterSpacing: "0.14em", marginBottom: 22, fontWeight: 500 }}>Say Hello</span>
          <h1 style={{ color: "#fff", fontSize: 72, lineHeight: 1.05, fontWeight: 700, letterSpacing: "-0.02em", margin: 0, maxWidth: 980 }}>Contact Photos 4 Real Estate</h1>
        </div>
