...
type RenderTargetLike = THREE.WebGLRenderTarget | null;
type TextureSource = { texture: THREE.Texture };
...
`;
    ...
    class Divergence extends ShaderPass {
      ...
      update(...args: any[]) {
        const { vel } = (args[0] || {}) as { vel?: TextureSource | null };
    ...
    class Poisson extends ShaderPass {
      ...
      update(...args: any[]): RenderTargetLike {
        ...
        let p_out: RenderTargetLike = null;
        const iter = iterations ?? 0;
        for (let i = 0; i < iter; i++) {
          const p_in: RenderTargetLike = i % 2 === 0 ? this.props.output0 : this.props.output1;
          p_out = i % 2 === 0 ? this.props.output1 : this.props.output0;
          if (!p_in || !p_out) return p_out;
    ...
    class Pressure extends ShaderPass {
      ...
      update(...args: any[]) {
        const { vel, pressure } = (args[0] || {}) as {
          vel?: TextureSource | null;
          pressure?: TextureSource | null;
        };
    ...
    class Simulation {
      ...
      update() {
        ...
        let vel: RenderTargetLike = this.fbos.vel_1;
